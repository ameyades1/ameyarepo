...
tsx_test:     file format elf64-x86-64
...
int main(int argc, char* argv[])
{
  ...
  400571:	48 89 75 f0          	mov    %rsi,-0x10(%rbp)
    printf("TSX Test...\n");
  400575:	bf 44 06 40 00       	mov    $0x400644,%edi
...
_xbegin (void)
{
  ...
  40057f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  400584:	c7 f8 00 00 00 00    	xbeginq 40058a <main+0x24>
		if (_xbegin() == _XBEGIN_STARTED) {
  40058a:	83 f8 ff             	cmp    $0xffffffff,%eax
  40058d:	75 11                	jne    4005a0 <main+0x3a>
		  printf ("_xbegin()");
  40058f:	bf 50 06 40 00       	mov    $0x400650,%edi
  400594:	b8 00 00 00 00       	mov    $0x0,%eax
  400599:	e8 a2 fe ff ff       	callq  400440 <printf@plt>
  40059e:	eb 12                	jmp    4005b2 <main+0x4c>
		}
		else {
		  printf("_xabort()"); 
  4005a0:	bf 5a 06 40 00       	mov    $0x40065a,%edi
  4005a5:	b8 00 00 00 00       	mov    $0x0,%eax
  4005aa:	e8 91 fe ff ff       	callq  400440 <printf@plt>
		  _xabort(0xFF);
  4005af:	c6 f8 ff             	xabort $0xff
		}
