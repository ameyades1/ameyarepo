...
public:
    ...
    PREDICTOR(uint8 _rat_size, uint8 _ghr_size, uint32 _ahrt_entries, uint32 _ahrt_associativity, uint32 _btb_entries, uint8 _gshare_size)
    {
    	PREDICTOR();
    	GHR_SIZE = _ghr_size;
