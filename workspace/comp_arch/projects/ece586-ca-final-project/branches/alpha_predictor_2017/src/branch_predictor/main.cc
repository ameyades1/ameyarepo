...
#ifdef __get_stats__
    printf ("\n-----Branch Stats-----\n");
    printf ("\n Direct: Count: %d Avg_Offset: %Lf", direct.branch_count, direct.avg);
    printf ("\n Indirect: Count: %d Avg_Offset: %Lf", indirect.branch_count, indirect.avg);
    printf ("\n Call: Count: %d Avg_Offset: %Lf", call.branch_count, call.avg);
    printf ("\n Conditional: Count: %d Avg_Offset: %Lf", cond.branch_count, cond.avg);
    printf ("\n Return: Count: %d Avg_Offset: %Lf", ret.branch_count, ret.avg);
    printf ("\n----------------------\n");
#endif
}
